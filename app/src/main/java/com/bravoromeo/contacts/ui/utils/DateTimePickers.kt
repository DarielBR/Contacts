    ...
    Row {
        Text(
            ...
            modifier=modifier
                .clickable {
                    datePicker.show()
                    onPick.invoke(pickedDate.toInstant().atZone(ZoneId.systemDefault()).toLocalDateTime())
                }
        )
    }
}
    ...
    Row {
        Text(
            ...
            modifier=modifier
                .clickable {
                    timePicker.show()
                    onPick.invoke(pickedTime.toInstant().atZone(ZoneId.systemDefault()).toLocalDateTime())
                }
        )
    }
}